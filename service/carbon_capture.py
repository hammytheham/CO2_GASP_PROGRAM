...
def main(rawusgs,grad,sur,user_job):
    ...
    phreeqc_input_carb_capt.main(experi1,smallusgs,eq_constants_value,user_job) #change executable file & change bash script
...
if __name__ == '__main__':
    main(rawusgs,grad,sur,user_job)
